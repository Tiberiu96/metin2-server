...
bool CHARACTER::AddAffect(DWORD dwType, BYTE bApplyOn, long lApplyValue, DWORD dwFlag, long lDuration, long lSPCost, bool bOverride, bool IsCube )
{
	...
	{
		ChatPacket(CHAT_TYPE_INFO, LC_TEXT_LANG("Your chat has been blocked by a GM.", GetLanguage()));
	}
	// END_OF_CHAT_BLOCK
...
bool CHARACTER::RemoveAffect(DWORD dwType)
{
	...
	{
		ChatPacket(CHAT_TYPE_INFO, LC_TEXT_LANG("Your chat block has been lifted.", GetLanguage()));
	}
	// END_OF_CHAT_BLOCK
