...
string g_strMallKey1 = "";
string g_strMallKey2 = "";
...
void config_init(const string& st_localeServiceName)
{
	...
	*log_db = '\0';
	...
	while (fgets(buf, 256, fp))
	{
		...
		TOKEN("mall_key1")
		{
			g_strMallKey1 = value_string;
		}

		TOKEN("mall_key2")
		{
			g_strMallKey2 = value_string;
		}
...
void CheckClientVersion()
{
	...
	while (it != set.end())
	{
		...
		if (version != date) // Fix
		{
			d->GetCharacter()->ChatPacket(CHAT_TYPE_NOTICE, LC_TEXT_LANG(LC_TEXT("Ŭ���̾�Ʈ ������ Ʋ�� �α׾ƿ� �˴ϴ�. ���������� ��ġ �� �����ϼ���."), d->GetCharacter()->GetLanguage()));
