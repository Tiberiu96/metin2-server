...
void CheckClientVersion()
{
	...
	while (it != set.end())
	{
		...
		if (version != date) // Fix
		{
			d->GetCharacter()->ChatPacket(CHAT_TYPE_NOTICE, LC_TEXT_LANG("You do not have the correct client version. Please install the normal patch.", d->GetCharacter()->GetLanguage()));
