...
extern DWORD GetPrivateShopBundleVnum(DWORD dwPolyVnum, BYTE bTitleType, BYTE bPageCount);

enum EPrivateShopBundleVnum
{
	PRIVATE_SHOP_BUNDLE_VNUM = 50200,
	PRIVATE_SHOP_PREMIUM_BUNDLE_VNUM = 71221,
};
