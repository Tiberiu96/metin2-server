...
$names = @('DeletePrivateShop', 'PrivateShopGameDespawn', 'PrivateShopStartPremiumEvent', 'PrivateShopEndPremiumEvent', 'IsPrivateShopPremiumEvent', 'UpdatePrivateShopPremiumEvent', 'PrivateShopFailedBuy', 'PrivateShopBuy', 'PrivateShopWithdraw')
